...
default:
	...
	cp $(SWIFT_BUILD_PATH)/{App,Stub} Multi.app/Contents/MacOS/
...
release:
	...
	codesign --sign "$$APPLE_DEVELOPER_SIGNING_IDENTITY" --timestamp --options runtime Multi.app/Contents/{Frameworks/*,MacOS/*}
